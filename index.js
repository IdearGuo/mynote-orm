...
orm.waterline.initialize(waterline.config, function (err, models) {
	if (err) {
		return console.error(err);
	}

	console.log('Be cool! Our waterline initialize successfully, yeah!');
...
app.post('/register',function(req,res){
	...
	req.models.findOne({username:username},function(err,user){
		if(err){
			console.log(err);
			return res.render('register',{
				user:req.session.user,
...
app.get('/delete',function(req,res){
	...
	req.models.destroy({_id:id},function(err){
		if(err){
			console.log(err);
			res.redirect('/')
		}else{
